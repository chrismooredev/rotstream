...
EnumTuple LOGGING_FLAGS_VALUES[] = {
	MAKE_TUPLE(LOG_SILENT),
	MAKE_TUPLE(LOG_RAWARGS),
	MAKE_TUPLE(LOG_PROCARGS),

	MAKE_TUPLE(LOG_GAI_DST),
	MAKE_TUPLE(LOG_GAI_SRC),
	MAKE_TUPLE(LOG_DNS),
	MAKE_TUPLE(LOG_SOCKCRTE),

	MAKE_TUPLE(LOG_ARGS),
	MAKE_TUPLE(LOG_CALCHAND),
	MAKE_TUPLE(LOG_PROC_READ),
	MAKE_TUPLE(LOG_PROC_WRITE),
	MAKE_TUPLE(LOG_CONNHAND),

	MAKE_TUPLE(LOG_DEFAULT)
};
